...
function preloadAll(p) {
  for (let i = 1; i <= 5; i++) {
    images.push(p.loadImage(`/cabeza-de-chivo-website/assets/img/photo/masked-polaroids/masked-${i}.jpg`));
  }
  images.push(p.loadImage(`/cabeza-de-chivo-website/assets/img/photo/masked-polaroids/the-mask.jpg`));
}
